...
const appCss = "/assets/styles-BVPu86Si.css";
...
const Route$b = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Professional eco-friendly carpet, tile, rug and upholstery cleaning in Perth. Bond-back guarantee. Book your free quote with Sparkletic today."
      },
      { name: "author", content: "Sparkletic" },
      { property: "og:title", content: "Sparkletic — Perth's Trusted Carpet Cleaning Experts" },
      { property: "og:description", content: "Eco-friendly steam cleaning across Perth. Carpets, tiles, rugs & upholstery. 500+ 5-star reviews." },
...
const $$splitComponentImporter$a = () => import("./services-DJ49Z4kQ.js");
const Route$a = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore Sparkletic's full range of professional cleaning services in Perth: carpet, vacate, tile & grout, rug, upholstery, and window cleaning."
    }, {
      property: "og:title",
      content: "Our Cleaning Services — Sparkletic Perth"
    }, {
      property: "og:description",
      content: "Full range of eco-friendly cleaning services across Perth — carpets, tiles, upholstery, windows and more."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./contact-Bv7McN1t.js");
const Route$9 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Request a free, no-obligation quote for carpet, tile, rug or upholstery cleaning in Perth. Call (08) 6261 5940 or fill out our quick form."
    }, {
      property: "og:title",
      content: "Contact Sparkletic — Free Quote"
    }, {
      property: "og:description",
      content: "Get a free same-day quote for your Perth cleaning job. Bond-back guarantee. 48hr re-clean promise."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./about-DNVnVzhh.js");
const Route$8 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Meet the Sparkletic team. 10+ years of eco-friendly carpet and upholstery cleaning in Perth. Proud CCAWA members committed to 5-star service."
    }, {
      property: "og:title",
      content: "About Sparkletic — Perth's Carpet Cleaning Specialists"
    }, {
      property: "og:description",
      content: "Family-owned, eco-first cleaning team trusted by 500+ Perth households and businesses."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./index-DEnVArXk.js");
const Route$7 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Professional eco-friendly steam carpet, tile, rug & upholstery cleaning in Perth. Bond-back guarantee. CCAWA member. Book your free quote today."
    }, {
      property: "og:title",
      content: "Sparkletic — Perth's Trusted Carpet Cleaning Experts"
    }, {
      property: "og:description",
      content: "Eco-friendly steam cleaning for carpets, rugs, tiles & upholstery across Perth. No harsh chemicals. 48hr re-clean promise."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./index-sRAvPF_2.js");
const Route$6 = createFileRoute("/services/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore Sparkletic's carpet, vacate, tile and grout, rug, upholstery, and window cleaning services in Perth."
    }]
  }),
...
const SERVICES_CONTENT = {
  "carpet-cleaning": {
    ...
    heroDescription: "Deep steam carpet cleaning that removes embedded dirt, stains, odours, and allergens while staying safe for families and pets.",
    metaTitle: "Carpet Cleaning Perth | Sparkletic",
    metaDescription: "Professional carpet steam cleaning in Perth with eco-friendly products, fast drying times, and 5-star service.",
    intro: "Our high-temperature extraction process is designed to restore carpet appearance, hygiene, and freshness in one visit.",
    includes: [
  ...
  "vacate-cleaning": {
    ...
    heroDescription: "Comprehensive vacate cleans for tenants, landlords, and property managers with a detailed, checklist-based approach.",
    metaTitle: "Vacate Cleaning Perth | Sparkletic",
    metaDescription: "End-of-lease vacate cleaning in Perth with bond-focused attention to detail for rentals and managed properties.",
    intro: "We clean with real estate expectations in mind so your property is presented in a bond-ready condition.",
    includes: [
  ...
  "tile-grout-cleaning": {
    ...
    heroDescription: "Professional tile and grout cleaning to lift embedded grime and restore the natural look of your tiled areas.",
    metaTitle: "Tile & Grout Cleaning Perth | Sparkletic",
    metaDescription: "Professional tile and grout cleaning in Perth for kitchens, bathrooms, and high-traffic floors.",
    intro: "Using specialist equipment and controlled pressure, we clean deeply without the harshness of DIY scrubbing.",
    includes: [
  ...
  "rug-cleaning": {
    ...
    heroDescription: "Care-focused rug cleaning for modern and delicate rugs, including wool and specialty fibres.",
    metaTitle: "Rug Cleaning Perth | Sparkletic",
    metaDescription: "Professional rug cleaning services in Perth with fibre-safe treatment and careful stain handling.",
    intro: "Rugs require tailored care. We assess fibre type, construction, and condition before selecting treatment steps.",
    includes: [
  ...
  "upholstery-cleaning": {
    ...
    heroDescription: "Safe upholstery cleaning that removes buildup, odours, and everyday staining while protecting fabric condition.",
    metaTitle: "Upholstery Cleaning Perth | Sparkletic",
    metaDescription: "Professional upholstery cleaning in Perth for sofas, lounges, and fabric furniture using eco-safe methods.",
    intro: "Your furniture sees daily use. We help restore freshness and comfort with careful, fabric-appropriate cleaning.",
    includes: [
  ...
  "window-cleaning": {
    ...
    heroDescription: "Professional window cleaning for clear, streak-free glass and improved curb appeal across residential and commercial properties.",
    metaTitle: "Window Cleaning Perth | Sparkletic",
    metaDescription: "Reliable window cleaning in Perth for homes and businesses, including internal and external glass.",
    intro: "Clean windows transform how a property looks and feels. We deliver consistent, detail-focused results.",
    includes: [
...
const $$splitComponentImporter$5 = () => import("./window-cleaning-ChfxH6kK.js");
const content$5 = SERVICES_CONTENT["window-cleaning"];
const Route$5 = createFileRoute("/services/window-cleaning")({
  head: () => ({
    meta: [{
      title: content$5.metaTitle
    }, {
      name: "description",
      content: content$5.metaDescription
    }, {
      property: "og:title",
      content: content$5.metaTitle
    }, {
      property: "og:description",
      content: content$5.metaDescription
    }]
...
const $$splitComponentImporter$4 = () => import("./vacate-cleaning-CZEhRvUi.js");
const content$4 = SERVICES_CONTENT["vacate-cleaning"];
const Route$4 = createFileRoute("/services/vacate-cleaning")({
  head: () => ({
    meta: [{
      title: content$4.metaTitle
    }, {
      name: "description",
      content: content$4.metaDescription
    }, {
      property: "og:title",
      content: content$4.metaTitle
    }, {
      property: "og:description",
      content: content$4.metaDescription
    }]
...
const $$splitComponentImporter$3 = () => import("./upholstery-cleaning-BLIfhqPL.js");
const content$3 = SERVICES_CONTENT["upholstery-cleaning"];
const Route$3 = createFileRoute("/services/upholstery-cleaning")({
  head: () => ({
    meta: [{
      title: content$3.metaTitle
    }, {
      name: "description",
      content: content$3.metaDescription
    }, {
      property: "og:title",
      content: content$3.metaTitle
    }, {
      property: "og:description",
      content: content$3.metaDescription
    }]
...
const $$splitComponentImporter$2 = () => import("./tile-grout-cleaning-D5JiaTa9.js");
const content$2 = SERVICES_CONTENT["tile-grout-cleaning"];
const Route$2 = createFileRoute("/services/tile-grout-cleaning")({
  head: () => ({
    meta: [{
      title: content$2.metaTitle
    }, {
      name: "description",
      content: content$2.metaDescription
    }, {
      property: "og:title",
      content: content$2.metaTitle
    }, {
      property: "og:description",
      content: content$2.metaDescription
    }]
...
const $$splitComponentImporter$1 = () => import("./rug-cleaning-DZOIpS22.js");
const content$1 = SERVICES_CONTENT["rug-cleaning"];
const Route$1 = createFileRoute("/services/rug-cleaning")({
  head: () => ({
    meta: [{
      title: content$1.metaTitle
    }, {
      name: "description",
      content: content$1.metaDescription
    }, {
      property: "og:title",
      content: content$1.metaTitle
    }, {
      property: "og:description",
      content: content$1.metaDescription
    }]
...
const $$splitComponentImporter = () => import("./carpet-cleaning-D_UPDFVy.js");
const content = SERVICES_CONTENT["carpet-cleaning"];
const Route2 = createFileRoute("/services/carpet-cleaning")({
  head: () => ({
    meta: [{
...
const ServicesWindowCleaningRoute = Route$5.update({
  id: "/window-cleaning",
  path: "/window-cleaning",
  getParentRoute: () => ServicesRoute
});
const ServicesVacateCleaningRoute = Route$4.update({
  id: "/vacate-cleaning",
  path: "/vacate-cleaning",
  getParentRoute: () => ServicesRoute
});
const ServicesUpholsteryCleaningRoute = Route$3.update({
  id: "/upholstery-cleaning",
  path: "/upholstery-cleaning",
  getParentRoute: () => ServicesRoute
});
const ServicesTileGroutCleaningRoute = Route$2.update({
  id: "/tile-grout-cleaning",
  path: "/tile-grout-cleaning",
  getParentRoute: () => ServicesRoute
});
const ServicesRugCleaningRoute = Route$1.update({
  id: "/rug-cleaning",
  path: "/rug-cleaning",
  getParentRoute: () => ServicesRoute
});
const ServicesCarpetCleaningRoute = Route2.update({
  id: "/carpet-cleaning",
  path: "/carpet-cleaning",
  getParentRoute: () => ServicesRoute
});
const ServicesRouteChildren = {
  ServicesCarpetCleaningRoute,
  ServicesRugCleaningRoute,
  ServicesTileGroutCleaningRoute,
  ServicesUpholsteryCleaningRoute,
  ServicesVacateCleaningRoute,
  ServicesWindowCleaningRoute,
  ServicesIndexRoute
};
